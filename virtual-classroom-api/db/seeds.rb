...
# Messages
msg_1 = Message.create(content: "My potion smells bad.", sender: "student", subject: potions, instructor: severus, student: ron)
msg_a = Message.create(content: "You are hopeless.", sender: "instructor", subject: potions, instructor: severus, student: ron)
msg_2 = Message.create(content: "I think I made a bad luck potion.", sender: "student", subject: potions, instructor: severus, student: ron)
msg_3 = Message.create(content: "Professor, I turned my ears into dog ears.", sender: "student", subject: transfiguration, instructor: minerva, student: harry)
msg_b = Message.create(content: "Potter please pay attention next time.", sender: "instructor", subject: transfiguration, instructor: minerva, student: harry)
msg_4 = Message.create(content: "Look I'm a cat!", sender: "student", subject: transfiguration, instructor: minerva, student: hermoine)