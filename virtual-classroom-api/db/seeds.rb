...
# Messages
msg_1 = Message.create(content: "My potion smells bad.", instructor: severus, student: ron, lecture: pot_lec_2)
msg_2 = Message.create(content: "I think I made a bad luck potion.", instructor: severus, student: ron, lecture: pot_lec_3)
msg_3 = Message.create(content: "Professor, I turned my ears into dog ears.", instructor: minerva, student: harry, lecture: tra_lec_2)
msg_4 = Message.create(content: "Look I'm a cat!", instructor: minerva, student: hermoine, lecture: tra_lec_2)